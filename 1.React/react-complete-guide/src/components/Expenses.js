...
const Expenses = (props) => {
  return (
    <Card className={`expenses`}>
      ...
      <ExpenseItem date={props.items[3].date} title={props.items[3].title} amount={props.items[3].amount}></ExpenseItem>
      <ExpenseItem date={props.items[4].date} title={props.items[4].title} amount={props.items[4].amount}></ExpenseItem>
    </Card>
  );
}
